    ...
    <div class="header navbar navbar-inverse ">
      ...
      <div class="navbar-inner">
        <div class="header-seperation">
          ...
          <!-- BEGIN LOGO -->
          <a href="index.html">
            <img src="<c:url value="/resources/assets/img/logo.png" /> " class="logo" alt="" data-src="<c:url value="/resources/assets/img/logo.png" /> " data-src-retina="<c:url value="/resources/assets/img/logo2x.png" /> " width="106" height="21" />
          </a>
          <!-- END LOGO -->
          ...
          <div class="pull-right">
            <div class="chat-toggler sm">
              <div class="profile-pic">
                <img src="<c:url value="/resources/assets/img/profiles/avatar_small.jpg" /> " alt="" data-src="<c:url value="/resources/assets/img/profiles/avatar_small.jpg" /> " data-src-retina="<c:url value="/resources/assets/img/profiles/avatar_small2x.jpg" /> " width="35" height="35" />
